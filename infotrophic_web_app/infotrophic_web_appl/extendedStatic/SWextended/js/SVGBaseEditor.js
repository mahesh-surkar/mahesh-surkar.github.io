...
{	
	...
	params = { ignoreSlides: true };
	
	loadControls(controls, params);
...
var loadControls = function(controls, params)
{
	if (typeof params !== typeof undefined && typeof params.ignoreSlides !== typeof undefined && params.ignoreSlides == true)
	{
